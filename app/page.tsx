...
const TERM_LINES: { delay: number; color: string; text: string }[] = [
  { delay: 0, color: "#9aaa8c", text: "$ testquick connect --repo github.com/acme/checkout-app" },
...
const STEPS: Step[] = [
  { n: "01", icon: "⬡", title: "Connect your GitHub repo", desc: "Authorize GitHub and select a repository. TestQuickAI reads your branch, pulls the code, and begins mapping your application structure." },
        ...
        <header style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 2rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
              ...
              <span style={{ fontFamily: "'Geist', sans-serif", fontWeight: 600, fontSize: 16, letterSpacing: "-0.02em", color: C.ink }}>TestQuickAI</span>
              <span style={{
        ...
        <footer style={{ borderTop: `1px solid ${C.border}`, padding: "2.5rem 2rem", background: C.surface }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontFamily: "'Geist', sans-serif", fontWeight: 600, fontSize: 15, color: C.ink }}>TestQuickAI</span>
            </div>
            <span style={{ fontFamily: "'Geist', sans-serif", fontSize: 13, color: C.subtle }}>
              © {new Date().getFullYear()} TestQuickAI. All rights reserved.
            </span>
...
export default TestQuickAILanding;